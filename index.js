        ...
        if (pathname === '/webhook') {
          ...
          // Pengecekan keanggotaan channel
           const isMember = await isUserMember(userId, token, channelId);
            if (!isMember) {
                await sendMessage(chatId, '⚠️ Anda harus bergabung dengan channel terlebih dahulu untuk menggunakan bot ini. Silahkan bergabung dengan channel: https://t.me/dumbzzz', token);
